class AppConfig {
  ...
  static String get apiBaseUrl {
    final value = isDevelopment ? _devApiBaseUrl : _prodApiBaseUrl;
    if (!isDevelopment && Uri.tryParse(value)?.scheme != 'https') {
      throw StateError('La API de producción debe usar HTTPS.');
    }
